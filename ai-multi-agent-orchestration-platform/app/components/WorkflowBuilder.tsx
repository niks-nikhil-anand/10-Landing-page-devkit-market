              ...
              return (
                <React.Fragment key={node.name}>
                  ...
                  <button
                    ...
                    className={`relative p-4 rounded-xl border flex flex-col items-center gap-2 text-center transition-all duration-300 cursor-pointer shrink-0 ${isActive
                  ...
                  >
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-xs ${isActive ? "bg-white/20 text-white" : "bg-white/5 text-primary"
                      }`}>
                      {index + 1}
                    </div>
