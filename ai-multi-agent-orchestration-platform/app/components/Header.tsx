    ...
    <header className="fixed top-0 left-0 w-full z-50 px-4 md:px-8 py-5">
      <div className="max-w-7xl mx-auto bg-slate-950/70 backdrop-blur-xl border border-white/8 rounded-2xl px-6 py-3 flex items-center justify-between shadow-[0_12px_40px_rgba(0,0,0,0.6)] hover:border-white/12 transition-all duration-300">
        ...
        <a href="#" className="flex items-center gap-2.5 group">
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary shadow-[0_0_15px_rgba(99,102,241,0.3)]">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <a
            href="#contact"
            className="relative group overflow-hidden rounded-xl bg-gradient-to-r from-primary to-secondary px-5 py-2.5 text-xs font-bold text-white shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_30px_rgba(99,102,241,0.55)] transition-all duration-300"
          >
