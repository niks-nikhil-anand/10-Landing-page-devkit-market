...
const testimonials = [
  {
    rating: 5,
    quote: "Their patent filing process was incredibly efficient and transparent. We secured our intellectual property much faster than expected.",
  ...
  {
    rating: 5,
    quote: "The cloud dashboard gives us complete visibility into our global trademark portfolio.",
  ...
  {
    rating: 5,
    quote: "Professional legal expertise combined with outstanding technology.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg">
            See how founders, chief technology officers, and legal counsel secure their core IP assets on LexPatent™.
          </p>
        </div>
