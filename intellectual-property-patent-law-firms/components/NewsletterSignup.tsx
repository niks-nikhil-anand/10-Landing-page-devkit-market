      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-blue-300 text-xs font-semibold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-accent animate-pulse" /> Secure Global Filing
          </div>
          ...
          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Secure patents, trademarks, copyrights, and trade secrets with trusted legal experts and enterprise-grade cloud technology.
          </p>
          ...
          <div className="pt-4 flex items-center justify-center gap-2 text-slate-400 text-xs">
            ...
            <span>USPTO Registered & AES-256 Encrypted Legal Cloud</span>
          </div>

          {/* Integrated Newsletter Form */}
          <div className="max-w-md mx-auto pt-12 border-t border-white/10 mt-12 space-y-4">
            <h3 className="font-display font-extrabold text-base text-white">
              Subscribe to LexPatent™ Intelligence
            </h3>
            <p className="text-xs text-slate-400 font-normal">
              Receive the latest international USPTO updates, prior art search tips, and trademark protection guides directly to your inbox.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-2.5">
              ...
              {success && (
                <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20 text-left text-xs font-semibold text-green-400 flex items-center gap-2">
                  ...
                  <span>Success! You have been registered to our newsletter.</span>
                </div>
              )}
            </form>
          </div>
