...
const plans = [
  {
    ...
    priceMonthly: 199,
    priceAnnually: 159,
    description: "Essential docket tracking and trademark portals for active startups and small entities.",
    features: [
      "Patent Docket Tracking",
      "Trademark Status Dashboard",
      "Secure Client Portal access",
      "Standard email legal support",
      "USPTO basic compliance logs",
      "Confidential vault storage (5 GB)",
    ],
    popular: false,
  ...
  },
  {
    ...
    priceMonthly: 599,
    priceAnnually: 479,
    description: "Complete intellectual property management and AI assistance for scaling research firms.",
    features: [
      "Unlimited active Cases",
      "IP Portfolio Management boards",
      "AI Patent Search Assistant",
      "Advanced Valuation Analytics",
      "Priority 24/7 email & phone support",
      "Digital signatures integration",
      "Automated Docket Alert alarms",
      "Redundant secure vault (50 GB)",
    ],
    popular: true,
    cta: "Start Free Trial",
    href: "#contact",
  },
  {
    ...
    description: "Bespoke legal counsel, custom integrations, and SLA guarantees for Fortune companies.",
    features: [
      "Unlimited Users & Staff logins",
      "Dedicated legal counsel team",
      "Custom systems integrations (API)",
      "White-label portal configuration",
      "Contract and NDA templates manager",
      "ITAR / SOC-2 dedicated compliance",
      "Single Sign-On (SSO) layers",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg">
            Start tracking or launch full portfolio automation. Select the plan corresponding to your IP dockets scale.
          </p>
