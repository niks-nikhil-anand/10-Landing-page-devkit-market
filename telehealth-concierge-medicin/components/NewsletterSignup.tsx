      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-blue-300 text-xs font-semibold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-accent animate-pulse" /> Unified Cloud Infrastructure
          </div>

          <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl tracking-tight text-white leading-tight">
            Transform Patient Care with <br />
            <span className="bg-gradient-to-r from-blue-400 via-sky-300 to-teal-300 bg-clip-text text-transparent">
              Cloud-Powered Telehealth
            </span>
          </h2>

          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Empower healthcare professionals with secure virtual consultations, intelligent workflows, AI assistance, and enterprise-grade cloud infrastructure.
          </p>
          ...
          <div className="max-w-md mx-auto pt-12 border-t border-white/10 mt-12 space-y-4">
            <h3 className="font-display font-extrabold text-base text-white">
              Subscribe to HealthCloud™ Insights
            </h3>
            <p className="text-xs text-slate-400">
              Get the latest clinical automation case studies, regulatory updates, and platform guides directly to your inbox.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-2.5">
              ...
              {success && (
                <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20 text-left text-xs font-semibold text-green-400 flex items-center gap-2 animate-pulse-slow">
                  <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0" />
                  <span>Success! You have been registered to our newsletter list.</span>
                </div>
              )}
            </form>
          </div>
