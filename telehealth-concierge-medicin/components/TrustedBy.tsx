...
const metrics = [
  { value: 500, label: "Clinics", prefix: "+", icon: Building2 },
  { value: 120, label: "Hospitals", prefix: "", icon: Stethoscope },
  { value: 15, label: "Healthcare Networks", prefix: "", icon: HeartHandshake },
  { value: 80, label: "Active Patients", suffix: "K+", icon: Users },
  { value: 40, label: "Countries", prefix: "+", icon: Globe2 },
];

const logos = [
  { name: "MedLife", subtitle: "HEALTHCARE" },
  { name: "HealthFirst", subtitle: "HOSPITALS" },
  { name: "CareBridge", subtitle: "NETWORKS" },
  { name: "Nova Clinics", subtitle: "CLINICS" },
  { name: "WellCore", subtitle: "WELLNESS" },
  { name: "PrimeCare", subtitle: "PRIMARY CARE" },
];
