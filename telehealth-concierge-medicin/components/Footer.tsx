...
const solutionLinks = [
  { name: "Clinics", href: "#" },
  { name: "Hospitals", href: "#" },
  { name: "Private Practices", href: "#" },
  { name: "Concierge Medicine", href: "#" },
  { name: "Corporate Healthcare", href: "#" },
  { name: "Telemedicine Networks", href: "#" },
  { name: "Healthcare Startups", href: "#" },
];
...
export default function Footer() {
  return (
    <footer className="relative bg-slate-950 text-slate-400 overflow-hidden border-t-2 border-transparent">
      {/* Visual Accent top border matching Apple/Stripe aesthetics */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-8 lg:gap-12 pb-16 border-b border-slate-900">
          ...
          <div className="col-span-2 lg:col-span-4 space-y-6">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-normal">
              Secure, cloud-native telehealth and concierge medicine platform helping providers deliver exceptional virtual care worldwide.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-[11px] text-slate-500 font-medium">
            © 2026 HealthCloud™. All rights reserved.
          </div>
          ...
          <div className="text-[11px] text-slate-500 text-center md:text-right leading-relaxed font-normal max-w-xs">
            Built with secure cloud infrastructure for modern healthcare providers.
          </div>
        </div>
