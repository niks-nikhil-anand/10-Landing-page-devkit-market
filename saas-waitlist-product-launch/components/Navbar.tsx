...
import { Menu, X, ArrowRight, Cloud, Sun, Moon } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative flex items-center justify-center w-9.5 h-9.5 rounded-xl bg-gradient-to-tr from-primary to-secondary text-white shadow-md shadow-primary/20 transition-transform group-hover:scale-105">
            ...
            <nav className="hidden lg:flex items-center gap-1.5">
              {navItems.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="px-4 py-2 rounded-lg text-sm font-semibold text-slate-655 dark:text-slate-300 hover:text-primary dark:hover:text-primary hover:bg-slate-100/50 dark:hover:bg-slate-800/30 transition-colors"
                >
                  {item.name}
                </Link>
              ))}
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <button
                ...
                className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-850 transition-colors cursor-pointer"
              ...
              <Link
                href="#contact"
                className="px-4 py-2.5 text-sm font-bold text-slate-700 dark:text-slate-205 hover:text-primary dark:hover:text-primary transition-colors"
              >
                Book Demo
              </Link>
              <Link
            ...
            <div className="flex items-center gap-1.5 lg:hidden">
              ...
              <button
                ...
                className="p-2 rounded-xl text-slate-605 dark:text-slate-300 hover:bg-slate-100/50 dark:hover:bg-slate-800/30 focus:outline-none transition-colors"
              ...
              <div className="px-4 pt-2 pb-6 space-y-1 sm:px-6">
                ...
                <div className="pt-4 border-t border-slate-200/50 dark:border-slate-800/50 flex flex-col gap-3 px-4">
                  <Link
                    href="#contact"
                    onClick={() => setIsOpen(false)}
                    className="w-full text-center py-3 text-sm font-bold text-slate-705 dark:text-slate-205 hover:bg-slate-100/50 dark:hover:bg-slate-800/30 rounded-xl transition-colors"
                  >
                    Book Demo
                  </Link>
                  <Link
