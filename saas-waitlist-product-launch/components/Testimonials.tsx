...
const testimonials = [
  {
    rating: 5,
    quote: "The product preview looks incredibly polished. Excited to get early access.",
  ...
  {
    rating: 5,
    quote: "The roadmap aligns perfectly with what modern teams need.",
  ...
  {
    rating: 5,
    quote: "We've already joined the waitlist for our entire company.",
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl tracking-tight text-slate-900 dark:text-white leading-tight">
            ...
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              Innovative SaaS Founders
            </span>
          </h2>
          <p className="text-slate-655 dark:text-slate-300 text-base sm:text-lg">
            See why technical product managers and startup founders are register-queuing for early beta access.
          </p>
        </div>
          ...
          {testimonials.map((test, idx) => (
            ...
            >
              ...
              <div className="relative z-10 space-y-5 text-left">
                ...
                {/* Quote */}
                <p className="text-sm sm:text-base text-slate-705 dark:text-slate-200 italic leading-relaxed font-normal">
                  &ldquo;{test.quote}&rdquo;
                </p>
              </div>

              {/* Author Footer */}
              <div className="flex items-center gap-3.5 pt-6 mt-6 border-t border-slate-105 dark:border-slate-805 relative z-10">
