      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 relative z-10">
          ...
          <div className="col-span-2 lg:col-span-4 space-y-6">
            <Link href="/" className="flex items-center gap-2 group w-fit">
              ...
              <span className="font-display font-extrabold text-lg tracking-tight text-white">
                LeadFlow <span className="text-primary font-sans font-medium text-xs align-super">Cloud™</span>
              </span>
            </Link>

            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-normal">
              AI-powered B2B sales funnel and lead generation platform helping businesses capture, nurture, and convert prospects into loyal customers.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-[11px] text-slate-500 font-medium">
            © 2026 LeadFlow Cloud™. All Rights Reserved.
          </div>
          ...
          <div className="flex items-center gap-6 text-[10px] text-slate-500 font-semibold">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>AES-256 Encrypted Cloud</span>
            </div>
          </div>

          <div className="text-[11px] text-slate-500 text-center md:text-right leading-relaxed font-normal max-w-xs">
            Helping businesses accelerate growth through intelligent sales automation.
          </div>
        </div>
