          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-display font-extrabold text-xl tracking-tight text-slate-900 dark:text-white">
                LeadFlow <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Cloud</span><span className="text-primary font-sans font-medium text-xs align-super">™</span>
              </span>
            </Link>
            ...
            {/* Mobile menu and mode toggle triggers */}
