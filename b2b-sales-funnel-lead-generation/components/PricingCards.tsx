...
const plans = [
  {
    ...
    priceMonthly: 49,
    priceAnnually: 39,
    description: "Essential sales funnel tools and basic dockets for emerging startups.",
    features: [
      "1,000 Active Leads database",
      "Standard CRM pipeline dashboard",
      "Basic automation triggers",
      "Email and dashboard analytics",
  ...
  },
  {
    ...
    priceMonthly: 149,
    priceAnnually: 119,
    description: "Advanced lead qualification and outreach engines for scaling sales teams.",
    features: [
      "Unlimited active Leads database",
      "Advanced AI lead scoring models",
      "Full CRM pipeline stage tracking",
  ...
  },
  {
    ...
    description: "Bespoke integrations, custom licensing, and dedicated success directors.",
    features: [
      "Unlimited Everything (Leads & Seats)",
      "Dedicated Customer Success manager",
      "Custom API database integrations",
      "White-label dashboard portals",
      "Priority 24/7/365 SLA support",
      "ITAR / SOC-2 dedicated compliance",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg">
            Start free or launch full sales automation. Select the plan matching your pipeline scale.
          </p>

          {/* Billing Switch */}
          <div className="flex items-center justify-center gap-3 pt-6">
            <span className={`text-sm font-semibold transition-colors ${billingPeriod === "monthly" ? "text-slate-900 dark:text-white" : "text-slate-405"}`}>
              Monthly billing
            </span>
            <button
              onClick={() => setBillingPeriod(billingPeriod === "monthly" ? "annually" : "monthly")}
              className="relative w-12 h-6 rounded-full bg-slate-200 dark:bg-slate-850 p-0.5 transition-colors focus:outline-none cursor-pointer"
            ...
            <span className={`text-sm font-semibold transition-colors flex items-center gap-1.5 ${billingPeriod === "annually" ? "text-slate-900 dark:text-white" : "text-slate-405"}`}>
