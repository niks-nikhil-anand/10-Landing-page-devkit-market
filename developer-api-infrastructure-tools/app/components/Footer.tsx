...
export default function Footer() {
  ...
  const colResources = [
    ...
    { name: "Quickstart Templates", href: "#" },
  ...
  const partners = [
    ...
    { name: "Google Cloud", color: "hover:text-[#4285F4]" },
    { name: "Azure", color: "hover:text-[#0089D6]" },
    { name: "Docker", color: "hover:text-[#2496ED]" },
    { name: "Kubernetes", color: "hover:text-[#326CE5]" },
    { name: "GitHub", color: "hover:text-white" },
    { name: "Cloudflare", color: "hover:text-[#F38020]" },
    { name: "Datadog", color: "hover:text-[#632CA6]" },
    { name: "Grafana", color: "hover:text-[#F46300]" },
  ...
  return (
    <footer className="bg-slate-950 text-gray-400 border-t border-white/5 pt-20 pb-12 relative overflow-hidden api-mesh">
      {/* Background Dots */}
      <div className="absolute inset-0 api-grid-dots opacity-30 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="glass-card p-8 md:p-12 border-white/6 rounded-2xl shadow-xl bg-slate-900/60 mb-20 flex flex-col lg:flex-row gap-8 justify-between items-center relative overflow-hidden">
          ...
          <div className="flex flex-col gap-3 text-center lg:text-left max-w-2xl">
            <div className="flex items-center gap-2 justify-center lg:justify-start">
              ...
              <span className="text-[10px] font-extrabold uppercase text-success tracking-widest">
                Start deployment in seconds
              </span>
            </div>
            <h3 className="text-2xl md:text-3xl font-extrabold text-white">
              Ready to Build Your Next Scalable Application?
            </h3>
            <p className="text-xs md:text-sm text-gray-400 leading-relaxed">
              Start with a free account today or schedule a personalized demo with our solutions engineers.
            </p>
            {/* Credentials row */}
            <div className="flex flex-wrap gap-x-8 gap-y-2 justify-center lg:justify-start pt-3 border-t border-white/5 mt-2 text-xs font-semibold">
              ...
              <span className="text-white">50M+ <span className="text-gray-500 font-normal">Daily Requests</span></span>
              <span className="text-white">15,000+ <span className="text-gray-500 font-normal">Developers</span></span>
              <span className="text-white">SOC 2 <span className="text-gray-500 font-normal">Certified</span></span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3.5 shrink-0 w-full sm:w-auto">
            <a
              href="#contact"
              className="px-6 py-3.5 bg-primary hover:bg-blue-600 text-white rounded-xl font-bold text-center text-xs flex items-center justify-center gap-1.5 shadow-[0_0_20px_rgba(59,130,246,0.25)]"
            >
              Get Started Free
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-8 pb-16 border-b border-white/5">
          ...
          <div className="xl:col-span-1 flex flex-col gap-4">
            ...
            <p className="text-xs leading-relaxed text-gray-500 pr-1">
              Automated multi-region server scaling, database replications, and developer API gate-keepers.
            </p>
          </div>
          ...
          {/* Column 7: Contact & Newsletter */}
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              <h4 className="text-[10px] uppercase font-extrabold text-white tracking-widest">
                Contact HQ
              </h4>
              <div className="flex flex-col gap-2.5 text-xs text-gray-500 font-semibold font-code">
                <div className="flex gap-2 items-start">
                  <MapPin className="w-3.5 h-3.5 text-primary shrink-0 mt-0.5" />
                  <span>500 Innovation Drive, San Francisco, CA</span>
                </div>
                <div className="flex gap-2 items-center">
                  <Phone className="w-3.5 h-3.5 text-primary shrink-0" />
                  <span>+1 (800) 555-2026</span>
                </div>
                <div className="flex gap-2 items-start flex-col">
                  <div className="flex gap-2 items-center">
                    <Mail className="w-3.5 h-3.5 text-primary shrink-0" />
                    <a href="mailto:hello@developerplatform.com" className="hover:text-white text-gray-400">hello@developerplatform.com</a>
                  </div>
                  <span className="pl-5.5 text-[10px] text-gray-600">Support: support@developerplatform.com</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 pt-3 border-t border-white/5">
              <span className="text-[10px] font-extrabold text-white uppercase tracking-wider">Stay Ahead</span>
                ...
                {!isSubscribed ? (
                  <form onSubmit={handleSubscribe} className="flex flex-col gap-2">
                    ...
                    <span className="text-[8px] text-gray-600 leading-tight block">
                      We dispatch security alerts and changelogs. Opt-out at any time.
                    </span>
                  </form>
                ) : (
                  <motion.div
        ...
        <div className="py-8 border-b border-white/5">
          <span className="block text-[10px] font-extrabold text-gray-500 uppercase tracking-widest text-center mb-6">
            Natively integrated with developer environments
          </span>
        ...
        <div className="pt-10 flex flex-col md:flex-row gap-6 items-center justify-between text-[11px] font-medium text-gray-500">
          ...
          <div className="flex flex-col gap-1 items-center md:items-start text-center md:text-left">
            <span className="font-extrabold text-gray-300">&copy; 2026 Developer API & Infrastructure Tools. All Rights Reserved.</span>
            <span className="text-[9px] text-gray-600 flex items-center gap-1.5 justify-center md:justify-start">
              <ShieldCheck className="w-3.5 h-3.5 text-primary" />
              SOC 2 Type II Audited and ISO 27001 Compliant platform nodes.
            </span>
          </div>
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center md:justify-start pt-6 border-t border-white/5 mt-6 text-[10px] font-bold">
          ...
          <span className="ml-auto text-gray-600 font-normal hidden md:inline">Built for developers. Engineered for scale. Trusted by enterprises.</span>
        </div>
